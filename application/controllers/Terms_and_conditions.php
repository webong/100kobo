...
class Terms_And_Conditions extends MY_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('is_logged_in')) {
			...
			$data_3['access'] = $this->session->userdata(
				'access');
			...
			$header['description'] = 'Using our Services does not give you ownership of any intellectual property rights in our Services or the content you access. You may not use content from our Services unless you obtain permission from it';
			$header['site_name'] = '100kobo';
			$header['url'] = site_url().'terms-and-conditions';

			$this->load->view('home/header', $header);
			$this->load->view('home/left-container', $data_1);
			$this->load->view('special/terms_and_conditions');
