...
class Privacy_Policy extends MY_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('is_logged_in')) {
			...
			$header['description'] = 'As you use our services, we want you to be clear how we are using information and the ways in which you can protect your privacy with us. Your privacy matters to 100Kobo.';
			$header['site_name'] = '100kobo';
			$header['url'] = site_url().'privacy-policy';

			$this->load->view('home/header', $header);
			$this->load->view('home/left-container', $data_1);
			$this->load->view('special/privacy_policy');
