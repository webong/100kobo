...
class Developers extends MY_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('is_logged_in')) {
			...
			$header['description'] = 'Writing the 100kobo program was a joy. This website and its functionalities has everything the users need for informative, interesting and entertaining experience.';
			$header['site_name'] = '100kobo';
			$header['url'] = site_url().'developers';

			$this->load->view('home/header', $header);
			$this->load->view('home/left-container', $data_1);
			$this->load->view('special/developers');
