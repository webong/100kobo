...
class Your_Content_in_our_Services extends MY_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('is_logged_in')) {
			...
			$header['title'] = 'Your content is in our Services';
			...
			$header['description'] = 'Some of our Services allow you to upload, submit, store, send or receive content. You retain ownership of any intellectual property rights that you hold in that content. In short, what belongs to you stays yours.';
			$header['site_name'] = '100kobo';
			$header['url'] = site_url().'your-content-in-our-services';

			$this->load->view('home/header', $header);
			$this->load->view('home/left-container', $data_1);
			$this->load->view('special/your_content_in_our_services');
